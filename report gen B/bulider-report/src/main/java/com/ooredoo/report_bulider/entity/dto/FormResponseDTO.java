...
public class FormResponseDTO {
    ...
    FormResponseDTO(Long id, String name, String description, LocalDateTime createdAt, LocalDateTime updatedAt, Integer creatorId, List<FormComponentDTO> components, Set<Integer> assignedUserIds) {
        this.id = id;
        this.name = name;
    ...
    public static class FormResponseDTOBuilder {
        ...
        public FormResponseDTOBuilder id(Long id) {
            this.id = id;
            return this;
        }
